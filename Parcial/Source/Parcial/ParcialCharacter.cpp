...
AParcialCharacter::AParcialCharacter()
{
...
void AParcialCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AParcialCharacter::Move);
...
void AParcialCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
